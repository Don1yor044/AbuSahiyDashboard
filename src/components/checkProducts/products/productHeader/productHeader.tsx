...
export const ProductHeader = () => (
  <div className="py-5 rounded-[8px] shadow-[1px_1px_10px_rgba(124,124,124,0.3)] inline-block bg-gray-200">
    <Row className="flex justify-between items-center flex-nowrap">
      ...
      <div className="min-w-72 pr-[10px] border-r-2 border-[#ddd] text-center">
      ...
      <div className="min-w-40 pr-[10px] border-r-2 text-center border-[#ddd]">
        <Typography className="text-sm font-medium">
          Actual payment (CNY)
        </Typography>
      </div>
      <div className="min-w-36 pr-[10px] border-r-2 text-center border-[#ddd]">
        <Typography className="text-sm font-medium">
          Payment fee (so'm)
        </Typography>
      </div>
